...
export function FoundersBadgeHybrid({ initialClaimed, initialRemaining }: FoundersBadgeHybridProps) {
  ...
  return (
    <div className="flex items-center justify-center space-x-2 bg-gradient-to-r from-purple-50 to-indigo-50 border border-purple-200 rounded-lg p-4" suppressHydrationWarning>
